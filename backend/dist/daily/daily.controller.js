...
const create_daily_dto_1 = require("./dto/create-daily.dto");
...
let DailyController = class DailyController {
    ...
    async create(req, createDailyDto) {
        try {
            return await this.dailyService.create(req.user, createDailyDto);
        }
        catch (e) {
            return { error: e.message, stack: e.stack };
        }
    }
    async findAll(req, userId, startDate, endDate, search) {
        const user = req.user;
        const filters = {
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new daily report' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_daily_dto_1.CreateDailyDto]),
    __metadata("design:returntype", Promise)
], DailyController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get reports visible to the current user' }),
    ...
    __metadata("design:returntype", Promise)
], DailyController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
...
], DailyController.prototype, "findOne", null);
